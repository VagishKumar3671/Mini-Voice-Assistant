...
HI! I AM JARVIS
    ...
    if 'youtube' in get.lower():
        ...
        with sr.Microphone() as source:
            ...
            try:
                ...
                youtube(r2.recognize_google(audio))
            except sr.UnknownValueError:
                print('ERROR')
            except sr.RequestError as e:
                print('failed'.format(e))
        ...
        with sr.Microphone() as source:
            ...
            try:
                print(r2.recognize_google(audio))
                amazon(r2.recognize_google(audio))
            except sr.UnknownValueError:
                print('ERROR')
            except sr.RequestError as e:
                print('failed'.format(e))
    ...
    elif 'favourite musics' in get.lower():
    ...
    elif 'motivational quote' in get.lower():
        speak('yes sir')
